...
namespace Solid
{
	...
	void GameCompiler::CreateScript(const std::string& _name)
	{
		...
		std::string RawCpp = "#include \""+ copyName+".hpp\"\n"
	                         ...
	                         "}\n"
		                     "\n"
					         "void "+copyName+"::Update() {\n"
		                     "\n"
		                     "\n"
		                     "};\n"
					         "void "+copyName+"::FixedUpdate() {\n"
		                     "\n"
		                     "\n"
		                     "};\n"
					         "void "+copyName+"::LateUpdate() {\n"
		                     "\n"
		                     "\n"
		                     "};\n"
		                     "\n";
	...
	bool GameCompiler::Build()
	{
		...
		std::string RawCpp = "#include \"Core/engine.hpp\"\n"
		                     ...
		                     "\t\t""engine->LateUpdate();\n"
		                     "\t\t""int x,y;\n"
		                     "\t\t""glfwGetWindowPos(engine->window->GetHandle(), &x,&y); Log::Send(\" x= \"+std::to_string(x)+ \" y= \"+std::to_string(y));\n"
